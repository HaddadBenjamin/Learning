...
export const getIdsSuccessAction = (payload: number[]): GetIdsSuccessAction => ({
	type: IdAction.GET_IDS_SUCCESS,
	payload
})
...
export const getPaginateIdsRequestAction = (page: number, pageSize: number): GetPaginateIdsRequestAction => ({
	type: IdAction.GET_PAGINATE_IDS_REQUEST,
	payload: {page, pageSize}
})

export const getPaginateIdsSuccessAction = (payload: IPaginateResponse<number>): GetPaginateIdsSuccessAction => ({
	type: IdAction.GET_PAGINATE_IDS_SUCCESS,
	payload
})

export const getPaginateIdsFailedAction = (error: string): GetPaginateIdsFailedAction => ({
	type: IdAction.GET_PAGINATE_IDS_FAILED,
	error
})
