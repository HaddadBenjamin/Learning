...
import {featureFlagReducerKey, featureFlagSagaKey} from "../domains/featureFlag/featureFlag.configuration";
...
export const useFeatureFlags = (...featureFlagsIds : number[]) : boolean[] =>
{
