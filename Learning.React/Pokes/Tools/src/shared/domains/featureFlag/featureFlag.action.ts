...
export const getFeatureFlagsSuccessAction = (payload: FeatureFlag[]) : GetFeatureFlagsSuccessAction => ({
	type: FeatureFlagAction.GET_FEATURE_FLAG_SUCCESS,
	payload
})

export const getFeatureFlagsFailedAction = (error : string) : GetFeatureFlagsFailedAction => ({
	type: FeatureFlagAction.GET_FEATURE_FLAG_FAILED,
	error
})
