...
import {FeatureFlagAction, getFeatureFlagsFailedAction, getFeatureFlagsSuccessAction} from "./featureFlag.action";
...
export default function* todoSaga() : Generator {
	yield takeLatest(FeatureFlagAction.GET_FEATURE_FLAG_REQUEST, getFeatureFlagsSaga);
}