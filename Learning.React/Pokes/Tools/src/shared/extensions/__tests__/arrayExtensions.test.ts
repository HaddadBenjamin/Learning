...
describe("arrayExtensions", () =>
{
	...
	it("orderBy should be immutable 2", () =>
	{
		...
		// Then
		expect(array).toStrictEqual(expectedValue)
		expect(actualValue).toStrictEqual([{d : 42, index : 1}, { d : 36, index : 2}])
	})
	...
	it("orderByDesc should be immutable 2", () =>
	{
		...
		// Then
		expect(array).toStrictEqual(expectedValue)
		expect(actualValue).toStrictEqual([{ d : 36, index : 2}, {d : 42, index : 1}])
	})
	...
	it("toDictionary should be immutable", () =>
	{
		...
		// Then
		expect(array).toStrictEqual(expectedValue)
		expect(actualValue).toStrictEqual(new Map([[0, { a: 1, id: 0 }], [1, { a: 2, id: 1 }]]))
	})
})