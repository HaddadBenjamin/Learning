...
const ResponsiveNavigationSample : FC = () =>
{
	...
	return <BrowserRouter>
		<header ref={componentReference}>
			<h2>Responsive navigation with lazy components and select of the current navigation element</h2>
			<nav className={styles.container}>
				...
				{ smOrBelow &&
					<>
						<button className={styles.navigationButton} onClick={toggleMobileNavigation}>Navigation button</button>
