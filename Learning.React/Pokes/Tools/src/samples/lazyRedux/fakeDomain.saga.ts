...
import {FakeDomainAction, getMessageFailedAction, getMessageSuccessAction} from "./fakeDomain.action";

export function* getMessageSaga()
{
	try
	{
		yield put(getMessageSuccessAction('Ce message a été chargé via un lazy réduceur et une lazy saga'));
	}
	catch (error : any)
	{
