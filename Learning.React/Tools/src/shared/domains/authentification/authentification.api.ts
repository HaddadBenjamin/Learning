...
import LOGIN_ENDPOINT, { GET_REFRESH_TOKEN_ENDPOINT, KEYCLOAK_CLIENT_ID } from './authentification.constant';
...
export const getKeycloakToken = ({ code, redirect_uri } : IGetKeycloakToken) : Promise<AxiosResponse<IJwtToken>> => axios.post<IJwtToken>(OPENID_CONNECT_TOKEN_ENDPOINT, XWwwFormUrlencoded({
  code,
